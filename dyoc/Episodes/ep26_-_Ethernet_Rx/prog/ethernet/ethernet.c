...
void main(void)
{
   ...
   while (1)
   {
      ...
      if (rdPtr + 1500 > pBufEnd)
         rdPtr = pBufStart;

//      putx16((uint16_t)rdPtr);
//      cputs("-");

      while (rdPtr == (uint8_t *)(MEMIO_STATUS->ethWrPtr)) // Repeat until data is received
      {
